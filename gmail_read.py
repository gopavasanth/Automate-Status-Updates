...
{	'Sender': '"email.com" <gopavasanth1999@email.com>', 
	'Subject': 'This is the testing for automated-script', 
	'Date': '2018-06-27', 
	'Snippet': 'Testing Mail'
	'Message_body': 'Hi Dear!!'}
The dictionary can be exported as a .csv or into a databse
'''

#exporting the values as .csv
with open('CSV_NAME.csv', 'w', encoding='utf-8', newline = '') as csvfile: 
    fieldnames = ['gopavasanth1999@gmail.com','Gmail-API','27-06-18','Hello Dear!','HI API']
